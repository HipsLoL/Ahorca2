 ...
 * @author Alumno
 */
public class PrototipoDiseño extends javax.swing.JFrame {

    /**
     * Creates new form PrototipoDiseño
     */
    public PrototipoDiseño() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrototipoDiseño.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrototipoDiseño().setVisible(true);
            }
        });
    }
