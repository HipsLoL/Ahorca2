 ...
 * @author Alumno
 */
public class MenúA2 extends javax.swing.JFrame {

    /**
     * Creates new form MenúA2
     */
    public MenúA2() {
        initComponents();
    }
    ...
    private void jBFacilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBFacilActionPerformed
        PrototipoDiseño p1 = new PrototipoDiseño();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenúA2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
